...
hid_begin = '<div class="indentation" id="comments"><div class="one-news-comments">' \
            '<div class="row header comments-js" data-show=".comments-block"><h2>'
...
style = '<style>.flexbox {display: flex;flex-flow: row wrap;align-items: flex-start;width: 100%; ' \
        'justify-content: left;}.productcard{background-color: #eaeaea;flex-direction: column;' \
        'justify-content: left;display: flex;border: 0px solid #445162;border-radius: 8px;box-sizing: border-box;' \
        'width: 300px;margin: 3px;}.productpic {padding: 0px 0px 0px 0px;height: 225px;}.producttext {width: 300px;' \
        '}</style>'
